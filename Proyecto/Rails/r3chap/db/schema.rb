...
ActiveRecord::Schema.define(version: 2018_07_26_002502) do
  ...
  create_table "etiquetas", force: :cascade do |t|
    ...
    t.index ["informativos_id"], name: "index_etiquetas_on_informativos_id"
    t.index ["usuarios_id"], name: "index_etiquetas_on_usuarios_id"
  end
