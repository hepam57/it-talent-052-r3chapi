...
class ElementosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create elemento" do
    assert_difference('Elemento.count') do
      post elementos_url, params: { elemento: { game: @elemento.game, scrore: @elemento.scrore } }
    end
  ...
  test "should update elemento" do
    patch elemento_url(@elemento), params: { elemento: { game: @elemento.game, scrore: @elemento.scrore } }
